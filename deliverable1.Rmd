...
suppressMessages(education_attainment <- read_csv("./Education.csv"))
...
```{r}
suppressMessages(sapply(education_attainment, typeof))
suppressMessages(sapply(education_attainment, mode))
```
